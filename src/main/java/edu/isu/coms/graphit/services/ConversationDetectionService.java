...
public class ConversationDetectionService {
    ...
    public void run(String keywords) {
        ...
        List<SolrDocument> searchresults =  rootTweetSolrRepository.findConversations(relevantHashtags, applicationEnvironment.getConversationsFilterLimit());
